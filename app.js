...
app.use('/', actionsRoute); // assuming some actions are public
...
app.use('/settings', checkAuth, checkPermission('access_settings'), settingsRoute);
app.use('/superuser', checkAuth, checkRole('Superuser'), superUserRoute);
app.use('/audit-log', checkAuth, checkPermission('view_audit_log'), auditLogRoute);
app.use('/notifications', checkAuth,checkPermission('view_notifications'), notificationsRoute);
