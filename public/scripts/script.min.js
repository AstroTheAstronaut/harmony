    ...
    if (e) {
        ...
        for (var l of o)
            l.addEventListener("click", function (o) {
                if ((document.body.classList.toggle("sidebar-toggled"), e.classList.toggle("toggled"), e.classList.contains("toggled"))) for (var l of t) l.hide();
            });
        window.addEventListener("resize", function () {
            if (Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0) < 768) for (var e of t) e.hide();
        });
    }
